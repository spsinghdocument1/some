...
{
    public partial class Token_Dlg2 : Form
    {
        long o = 0;
        public Token_Dlg2()
        {
     ...
     public   void lavesho(string token1)
        ...
        void ok()
        {
            ...
            string to1 = label8.Text;
            Select se = new Select();

            se.sho2(Exchange, order_type, Inst_type, symbol, exoiry, option_type, strike_price, to1);

           // this.Close();
            Token_Dlg2.ActiveForm.Close();
