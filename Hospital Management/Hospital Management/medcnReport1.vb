...
Public Class medcnReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hospital_Management.medcnReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Med() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedmedcnReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As medcnReport1 = New medcnReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
